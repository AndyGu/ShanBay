...
//      this.mNextFragment = nextFragmentFromInital();
//    while (true)
//    {
//      return this.mNextFragment;
//      if (TAG_EXPLORE.equals(this.mNextFragment))
//        this.mNextFragment = nextFragmentFromExpl();
//      else if (TAG_TEST_RECOGNITION.equals(this.mNextFragment))
//        this.mNextFragment = nextFragmentFromRecogn();
//      else if (TAG_SUMMARY.equals(this.mNextFragment))
//        this.mNextFragment = nextFragmentFromSummary();
//      else if (TAG_TEST_SPELL.equals(this.mNextFragment))
//        this.mNextFragment = nextFragmentFromSpell();
//    }
//  }
//
//  public void setResult(Result paramResult)
//  {
//    int i = this.mStudyData.reviewStatus;
//    this.mStudyData.reviewStatus = ReviewStatus.nextStatus(i, paramResult, 1);
//    adjustStudyQueue(this.mStudyData);
//    adjustReviewStat(i, this.mStudyData.reviewStatus);
//  }
//
